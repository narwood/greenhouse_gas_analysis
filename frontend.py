...
""")
data = pd.read_csv("/Users/mateo/Documents/PROJECTS/CDC - 2022/Annual_Greenhouse_Gas_(GHG)_Air_Emissions_Accounts.csv").drop(columns=['ObjectId2','ISO2', 'ISO3', 'Indicator', 'Code', 'Unit', 'Source', 'Scale'])
